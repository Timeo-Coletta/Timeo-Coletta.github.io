...
The above plot showcases the difference in arrest percentages between Rhode Island and Massachusetts, with RI higher than MA. However, the p-value is greater than 0.05 which means the difference is not statistically significant, which I infer is because the population densities of both states are extremely similar (so I'd assume they have stricter regulations around speeding). We cannot reject the null hypothesis (confidence interval of 95%).
